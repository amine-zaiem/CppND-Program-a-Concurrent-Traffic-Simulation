...
{
    _trafficLightPhase = TrafficLightPhase::red;
}
...
void TrafficLight::waitForGreen()
{
    ...
    while (true)
    {
        ...
        auto lightPhMsg = _queue.receive();
        if( lightPhMsg == TrafficLightPhase::green )
        {
            return;
        }
    }
...
void TrafficLight::cycleThroughPhases()
{
    ...
    while (true)
    {
        ...
        if ( lastUpdateDuration >= randomCycleDur )
        {
            if (_trafficLightPhase == TrafficLightPhase::red)
            {
                _trafficLightPhase =  TrafficLightPhase::green;
            }
            else
            {
                _trafficLightPhase = TrafficLightPhase::red;
